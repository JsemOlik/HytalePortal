...
/**
 * Command to create a blue portal.
 * Usage: /p1
 */
public class Portal1Command extends CommandBase {

    public Portal1Command() {
        super("p1", "Creates a Blue Portal in front of you");
    }

    @Override
    protected void executeSync(@Nonnull CommandContext ctx) {
        ctx.sendMessage(Message.raw("Creating Blue Portal...").color("blue"));
